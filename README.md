...
## 🎯 Hedef Kullanıcılar
* Öğrenciler
* Bütçesini ve günlük harcamalarını takip etmek isteyen bireyler

## ✨ Temel Özellikler
* **Kullanıcı İşlemleri:** Güvenli Kayıt Olma ve Giriş Yapma
* **Finansal İşlemler:** * Gelir ve Gider Ekleme (Harçlık, burs, fatura, market vb.)
  * Hatalı girilen işlemleri Silme
  * Mevcut kayıtları Güncelleme
* **Bakiye Takibi:** Toplam gelir, toplam gider ve güncel bakiyenin anlık olarak görüntülenmesi
